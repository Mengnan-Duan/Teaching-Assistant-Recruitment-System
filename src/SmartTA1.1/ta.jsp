...
async function applyPosition(code, name) {
    ...
    try {
        ...
        let json = await res.json();
        if (json.success) {
            showToast("Application submitted successfully for " + code, "success");
...
async function addSkillPrompt() {
    ...
    let suggestions = ["Java", "Python", "JavaScript", "Git", "Agile", "SQL", "React", "Node.js", "Machine Learning", "Data Analysis"];
