    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        switch (action) {
            ...
            case "workloads":
                ...
                String[] ids = {"A001","A002","A003","A004","A005","A006"};
                String[] names = {"Zhang Wei","Li Mei","Wang Hao","Chen Yu","Zhao Lin","Liu Na"};
                int[] hardcoded = {14, 10, 6, 24, 4, 22};
                for (int i = 0; i < ids.length; i++) {
                    int hours = workloads.containsKey(ids[i]) ? workloads.get(ids[i]) : hardcoded[i];
                    sb.append("\"").append(names[i]).append("\":").append(hours);
